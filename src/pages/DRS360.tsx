                      ...
                      <SwiperSlide key={i}>
                        <div className="px-4">
                          <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="auto" viewBox="0 0 422 379" fill="none">
                            ...
                            <path d="M83.6148 59.3589C77.9738 59.3589 73.3584 63.9743 73.3584 69.6153C73.3584 77.564 83.6148 87.564 83.6148 87.564C83.6148 87.564 93.8712 77.564 93.8712 69.6153C93.8712 63.9743 89.2558 59.3589 83.6148 59.3589Z" stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><path d="M83.6156 72.9486C85.4565 72.9486 86.9489 71.4563 86.9489 69.6153C86.9489 67.7744 85.4565 66.282 83.6156 66.282C81.7746 66.282 80.2822 67.7744 80.2822 69.6153C80.2822 71.4563 81.7746 72.9486 83.6156 72.9486Z" stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><path d="M88.7434 85H78.487C77.0708 85 75.9229 86.148 75.9229 87.5641V97.8205C75.9229 99.2366 77.0708 100.385 78.487 100.385H88.7434C90.1595 100.385 91.3075 99.2366 91.3075 97.8205V87.5641C91.3075 86.148 90.1595 85 88.7434 85Z" stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><path d="M75.9229 92.6923H91.3075" stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path><path d="M104.128 87.564V100.385M111.82 82.4358V100.385M119.513 77.3076V100.385" stroke="black" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"></path>
