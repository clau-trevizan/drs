...
export default function DRS360() {
  ...
  const solutionsData: SolutionModalData[] = [
    {
      title: t('drs360.sol1.title'),
      description: t('drs360.sol1.desc'),
      diferenciais: [t('drs360.sol1.dif1'), t('drs360.sol1.dif2'), t('drs360.sol1.dif3'), t('drs360.sol1.dif4')],
      destaques: [t('drs360.sol1.dest1'), t('drs360.sol1.dest2'), t('drs360.sol1.dest3')]
    },
    {
      title: t('drs360.sol2.title'),
      description: t('drs360.sol2.desc'),
      diferenciais: [t('drs360.sol2.dif1'), t('drs360.sol2.dif2'), t('drs360.sol2.dif3'), t('drs360.sol2.dif4')],
      destaques: [t('drs360.sol2.dest1'), t('drs360.sol2.dest2'), t('drs360.sol2.dest3')]
    },
    {
      title: t('drs360.sol3.title'),
      description: t('drs360.sol3.desc'),
      diferenciais: [t('drs360.sol3.dif1'), t('drs360.sol3.dif2'), t('drs360.sol3.dif3'), t('drs360.sol3.dif4')],
      destaques: [t('drs360.sol3.dest1'), t('drs360.sol3.dest2'), t('drs360.sol3.dest3')]
    },
    {
      title: t('drs360.sol4.title'),
      description: t('drs360.sol4.desc'),
      diferenciais: [t('drs360.sol4.dif1'), t('drs360.sol4.dif2'), t('drs360.sol4.dif3'), t('drs360.sol4.dif4')],
      destaques: [t('drs360.sol4.dest1'), t('drs360.sol4.dest2'), t('drs360.sol4.dest3')]
    },
    {
      title: t('drs360.sol5.title'),
      description: t('drs360.sol5.desc'),
      diferenciais: [t('drs360.sol5.dif1'), t('drs360.sol5.dif2'), t('drs360.sol5.dif3'), t('drs360.sol5.dif4')],
      destaques: [t('drs360.sol5.dest1'), t('drs360.sol5.dest2'), t('drs360.sol5.dest3')]
    },
    {
      title: t('drs360.sol6.title'),
      description: t('drs360.sol6.desc'),
      diferenciais: [t('drs360.sol6.dif1'), t('drs360.sol6.dif2'), t('drs360.sol6.dif3'), t('drs360.sol6.dif4')],
      destaques: [t('drs360.sol6.dest1'), t('drs360.sol6.dest2'), t('drs360.sol6.dest3')]
    }
  ];
  ...
  return (
    ...
    <img src={drs360Hero} alt="DRS 360" className="w-full h-full min-h-[200px] lg:min-h-[400px] object-cover rounded-t-[24px] lg:rounded-t-none lg:rounded-l-[32px] lg:rounded-tl-[40px] lg:rounded-bl-[40px]" />
    </div>
    ...
    <span className="text-[16px] lg:text-[20px]" style={{ color: '#000', fontStyle: 'normal', fontWeight: 400, lineHeight: '40px', textTransform: 'uppercase', borderRadius: '30px', border: '1px solid #000', padding: '0px 20px', display: 'inline-block', marginBottom: '1rem', width: 'fit-content', background: 'transparent' }}>{t('drs360.hero.tag')}</span>
    <h1 className="text-[22px] md:text-[28px] lg:text-[35px] leading-[28px] md:leading-[34px] lg:leading-[40px]" style={{ color: '#000', fontWeight: 900 }}>{t('drs360.hero.title')}</h1>
    </div>
    </div>
    </div>
    </div>
    ...
    <p style={{ color: '#000', fontSize: '20px', fontWeight: 400, lineHeight: '1.5' }} dangerouslySetInnerHTML={{ __html: t('drs360.text1') }} />
    <p style={{ color: '#000', fontSize: '20px', fontWeight: 400, lineHeight: '1.5' }}>{t('drs360.text2')}</p>
    <p style={{ color: '#000', fontSize: '20px', fontWeight: 900, lineHeight: '1.5' }}>{t('drs360.text3')}</p>
    </div>
    </div>
    </div>
    </div>
    ...
    <span style={{ color: '#000', fontSize: '20px', fontStyle: 'normal', fontWeight: 400, lineHeight: '40px', borderRadius: '30px', background: '#F39325', padding: '3px 30px', display: 'inline-block', textTransform: 'uppercase' }}>{t('drs360.funcionalidades')}</span>
    ...
    <text className="botao" x="49" y="175" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func1.line1')}</text>
    <text className="botao" x="49" y="198" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func1.line2')}</text>
    <text className="botao" x="49" y="225" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func1.line3')}</text>
    <text className="botao" x="49" y="249" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func1.line4')}</text>
    </svg>
    </div>
    ...
    <text className="botao" x="36" y="178" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func2.line1')}</text>
    <text className="botao" x="36" y="203" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func2.line2')}</text>
    <text className="botao" x="36" y="228" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func2.line3')}</text>
    <text className="botao" x="36" y="253" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func2.line4')}</text>
    <text className="botao" x="36" y="278" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func2.line5')}</text>
    </svg>
    </div>
    ...
    <text className="botao" x="49" y="180" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func3.line1')}</text>
    ...
    <text className="botao" x="42" y="174" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func4.line1')}</text>
    <text className="botao" x="42" y="199" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func4.line2')}</text>
    <text className="botao" x="42" y="224" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func4.line3')}</text>
    <text className="botao" x="42" y="249" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func4.line4')}</text>
    <text className="botao" x="42" y="274" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func4.line5')}</text>
    </svg>
    </div>
    ...
    <text className="botao" x="50" y="174" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func5.line1')}</text>
    <text className="botao" x="50" y="199" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func5.line2')}</text>
    <text className="botao" x="50" y="224" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func5.line3')}</text>
    <text className="botao" x="50" y="249" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func5.line4')}</text>
    </svg>
    </div>
    ...
    <text className="botao" x="42" y="168" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func6.line1')}</text>
    <text className="botao" x="42" y="193" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func6.line2')}</text>
    <text className="botao" x="42" y="218" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func6.line3')}</text>
    <text className="botao" x="42" y="243" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func6.line4')}</text>
    <text className="botao" x="42" y="268" fontSize="20" fontWeight="400" fill="#fff">{t('drs360.func6.line5')}</text>
    </svg>
    </div>
    </div>
    ...
    <Swiper modules={[Navigation, Pagination]} onSwiper={(swiper) => { functionalitiesSwiperRef.current = swiper; }} onSlideChange={(swiper) => setActiveFuncSlide(swiper.activeIndex)} spaceBetween={16} slidesPerView={1} className="w-full">
    {[1,2,3,4,5,6].map((i) => {
      const funcKey = `drs360.func${i}`;
      const lineCount = i === 2 || i === 4 || i === 6 ? 5 : 4;
      // Re-use same SVG shapes per block
      const circleProps = [
        { cx: 99, cy: 85 },
        { cx: 85, cy: 89 },
        { cx: 100, cy: 91 },
      ...
      const paths = [
        "M83.6148 59.3589C77.9738 59.3589 73.3584 63.9743 73.3584 69.6153C73.3584 77.564 83.6148 87.564 83.6148 87.564C83.6148 87.564 93.8712 77.564 93.8712 69.6153C93.8712 63.9743 89.2558 59.3589 83.6148 59.3589Z M83.6156 72.9486C85.4565 72.9486 86.9489 71.4563 86.9489 69.6153C86.9489 67.7744 85.4565 66.282 83.6156 66.282C81.7746 66.282 80.2822 67.7744 80.2822 69.6153C80.2822 71.4563 81.7746 72.9486 83.6156 72.9486Z M88.7434 85H78.487C77.0708 85 75.9229 86.148 75.9229 87.5641V97.8205C75.9229 99.2366 77.0708 100.385 78.487 100.385H88.7434C90.1595 100.385 91.3075 99.2366 91.3075 97.8205V87.5641C91.3075 86.148 90.1595 85 88.7434 85Z M75.9229 92.6923H91.3075 M104.128 87.564V100.385 M111.82 82.4358V100.385 M119.513 77.3076V100.385",
        "M65 76.7692L83.9767 62L102.953 76.7692V104.462C102.953 105.93 102.354 107.339 101.286 108.378C100.218 109.416 98.7703 110 97.2605 110H70.693C69.1831 110 67.7351 109.416 66.6674 108.378C65.5998 107.339 65 105.93 65 104.462V76.7692Z M72.8135 84.3256H95.1391M72.8135 95.4884H95.1391 M78.3949 80.9767H73.9298C73.3133 80.9767 72.8135 81.4765 72.8135 82.093V86.5581C72.8135 87.1746 73.3133 87.6744 73.9298 87.6744H78.3949C79.0114 87.6744 79.5112 87.1746 79.5112 86.5581V82.093C79.5112 81.4765 79.0114 80.9767 78.3949 80.9767Z M89.558 92.1395H85.0928C84.4763 92.1395 83.9766 92.6393 83.9766 93.2558V97.7209C83.9766 98.3374 84.4763 98.8372 85.0928 98.8372H89.558C90.1745 98.8372 90.6742 98.3374 90.6742 97.7209V93.2558C90.6742 92.6393 90.1745 92.1395 89.558 92.1395Z M92.9072 80.9767C97.4999 76.7907 101.71 74.6977 106.303 74.2791",
        "M99.9994 67.923L74.3584 111.513H125.64L99.9994 67.923Z M100 85.8717V96.1281 M99.9996 106.385C101.416 106.385 102.564 105.237 102.564 103.82C102.564 102.404 101.416 101.256 99.9996 101.256C98.5835 101.256 97.4355 102.404 97.4355 103.82C97.4355 105.237 98.5835 106.385 99.9996 106.385Z",
        "M91.7688 70.6409C94.6011 70.6409 96.897 68.345 96.897 65.5127C96.897 62.6805 94.6011 60.3845 91.7688 60.3845C88.9366 60.3845 86.6406 62.6805 86.6406 65.5127C86.6406 68.345 88.9366 70.6409 91.7688 70.6409Z M91.7694 70.641V80.8974M76.3848 93.7179V83.4615H107.154V93.7179M91.7694 83.4615V93.7179 M76.385 106.538C79.2173 106.538 81.5132 104.242 81.5132 101.41C81.5132 98.578 79.2173 96.282 76.385 96.282C73.5528 96.282 71.2568 98.578 71.2568 101.41C71.2568 104.242 73.5528 106.538 76.385 106.538Z M91.7688 106.538C94.6011 106.538 96.897 104.242 96.897 101.41C96.897 98.578 94.6011 96.282 91.7688 96.282C88.9366 96.282 86.6406 98.578 86.6406 101.41C86.6406 104.242 88.9366 106.538 91.7688 106.538Z M107.154 106.538C109.986 106.538 112.282 104.242 112.282 101.41C112.282 98.578 109.986 96.282 107.154 96.282C104.321 96.282 102.025 98.578 102.025 101.41C102.025 104.242 104.321 106.538 107.154 106.538Z",
        "M88.7432 64.4871V105.513 M88.7436 73.4615C90.8678 73.4615 92.5898 71.7395 92.5898 69.6153C92.5898 67.4911 90.8678 65.7692 88.7436 65.7692C86.6194 65.7692 84.8975 67.4911 84.8975 69.6153C84.8975 71.7395 86.6194 73.4615 88.7436 73.4615Z M88.7436 88.8461C90.8678 88.8461 92.5898 87.1241 92.5898 85C92.5898 82.8758 90.8678 81.1538 88.7436 81.1538C86.6194 81.1538 84.8975 82.8758 84.8975 85C84.8975 87.1241 86.6194 88.8461 88.7436 88.8461Z M88.7436 104.231C90.8678 104.231 92.5898 102.509 92.5898 100.385C92.5898 98.2604 90.8678 96.5385 88.7436 96.5385C86.6194 96.5385 84.8975 98.2604 84.8975 100.385C84.8975 102.509 86.6194 104.231 88.7436 104.231 M109.256 69.6154L119.513 72.1795V82.4359C119.513 90.1282 114.385 95.2564 109.256 97.8205C104.128 95.2564 99 90.1282 99 82.4359V72.1795L109.256 69.6154Z M106.692 84.9999L110.539 88.8461L119.513 81.923",
        "M81.4622 55.923H99.4109L112.231 68.7435V96.9486C112.231 98.3087 111.691 99.6131 110.729 100.575C109.768 101.537 108.463 102.077 107.103 102.077H81.4622C80.1021 102.077 78.7977 101.537 77.836 100.575C76.8743 99.6131 76.334 98.3087 76.334 96.9486V61.0512C76.334 59.6911 76.8743 58.3867 77.836 57.425C78.7977 56.4633 80.1021 55.923 81.4622 55.923Z M99.4102 55.923V68.7435H112.231 M94.5377 85.923V90.1379M81.8926 88.0305H94.5377H107.183 M81.8941 98.0622C83.4072 98.0622 84.6338 96.8356 84.6338 95.3225C84.6338 93.8094 83.4072 92.5828 81.8941 92.5828C80.3809 92.5828 79.1543 93.8094 79.1543 95.3225C79.1543 96.8356 80.3809 98.0622 81.8941 98.0622Z M94.5386 98.0622C96.0517 98.0622 97.2784 96.8356 97.2784 95.3225C97.2784 93.8094 96.0517 92.5828 94.5386 92.5828C93.0255 92.5828 91.7988 93.8094 91.7988 95.3225C91.7988 96.8356 93.0255 98.0622 94.5386 98.0622Z M107.183 98.0622C108.696 98.0622 109.923 96.8356 109.923 95.3225C109.923 93.8094 108.696 92.5828 107.183 92.5828C105.67 92.5828 104.443 93.8094 104.443 95.3225C104.443 96.8356 105.67 98.0622 107.183 98.0622Z",
      ];
      return (
        <SwiperSlide key={i}>
        <div className="px-4">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="auto" viewBox="0 0 422 379" fill="none">
        <path d="M250.06 332.091V356.592C250.06 368.56 259.746 378.261 271.695 378.261H397.529C410.704 378.261 421.388 367.563 421.388 354.364V91.5024C421.388 79.3338 411.541 69.4714 399.391 69.4714H383.752C372.189 69.4714 362.818 60.0821 362.818 48.5036V21.8453C362.818 9.78158 353.054 0 341.006 0L23.8594 1C10.6812 1 0 11.698 0 24.8969V288.573C0 301.512 10.4719 312 23.3899 312L229 311C240.629 311 250.057 320.443 250.057 332.091H250.06Z" fill="#274B41"/>
        <circle cx={circleProps[i-1].cx} cy={circleProps[i-1].cy} r="50" fill="#F39325"/>
        <path d={paths[i - 1]} stroke="black" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
        <text className="botao" x="42" y="175" fontSize="20" fontWeight="400" fill="#fff">{t(`${funcKey}.line1`)}</text>
    ...
    {[1,2,3,4,5,6].map((i, idx) => {
      ...
      const benefitPaths = [
          "M106.833 87.75H82.3333C80.0782 87.75 78.25 89.5782 78.25 91.8333V116.333C78.25 118.588 80.0782 120.417 82.3333 120.417H106.833C109.088 120.417 110.917 118.588 110.917 116.333V91.8333C110.917 89.5782 109.088 87.75 106.833 87.75Z M78.25 100H110.917 M131.333 79.5833L147.667 83.6666V99.9999C147.667 112.25 139.5 120.417 131.333 124.5C123.167 120.417 115 112.25 115 99.9999V83.6666L131.333 79.5833Z M131.333 91.8333V112.25 M125.208 106.125L131.333 112.25L137.458 106.125",
        "M31.501 1.5L7.50098 25.0664 M31.5 1.5L55.5 25.0664 M7.5 25.0664L1.5 19.1748M55.5 25.0664L61.5 19.1748",
        "M29.5059 56.5C44.9732 56.5 57.5119 44.1878 57.5119 29C57.5119 13.8122 44.9732 1.5 29.5059 1.5C14.0387 1.5 1.5 13.8122 1.5 29C1.5 44.1878 14.0387 56.5 29.5059 56.5Z M29.5059 15.25V29L46.3094 40",
        "M40.8333 36.75H16.3333C14.0782 36.75 12.25 38.5782 12.25 40.8333V65.3333C12.25 67.5885 14.0782 69.4167 16.3333 69.4167H40.8333C43.0885 69.4167 44.9167 67.5885 44.9167 65.3333V40.8333C44.9167 38.5782 43.0885 36.75 40.8333 36.75Z M12.25 49H44.9167 M65.3333 28.5833L81.6667 32.6666V48.9999C81.6667 61.2499 73.5 69.4166 65.3333 73.4999C57.1667 69.4166 49 61.2499 49 48.9999V32.6666L65.3333 28.5833Z M65.333 40.8333V61.2499 M59.208 55.125L65.333 61.25L71.458 55.125",
        "M31.501 1.5L7.50098 25.0664 M31.5 1.5L55.5 25.0664 M7.5 25.0664L1.5 19.1748M55.5 25.0664L61.5 19.1748",
        "M29.5059 56.5C44.9732 56.5 57.5119 44.1878 57.5119 29C57.5119 13.8122 44.9732 1.5 29.5059 1.5C14.0387 1.5 1.5 13.8122 1.5 29C1.5 44.1878 14.0387 56.5 29.5059 56.5Z M29.5059 15.25V29L46.3094 40"
      ];
      ...
      return(
        ...
        <g transform="translate(114 100) scale(0.9)">
        <path d={benefitPaths[idx]} transform="translate(-50 -50)" stroke="black" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
        </g>
