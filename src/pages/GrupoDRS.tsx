...
export default function GrupoDRS() {
  ...
  return (
    ...
    <Swiper modules={[Navigation, EffectCreative]} effect="creative" creativeEffect={{ prev: { translate: [0, 0, 0], opacity: 0 }, next: { translate: [0, 0, 0], opacity: 0 } }} onSwiper={(swiper) => { missaoCarouselRef.current = swiper; }} onSlideChange={(swiper) => setMissaoActiveSlide(swiper.activeIndex)} spaceBetween={24} slidesPerView={1} className="drs360-swiper h-full w-full mt-0 lg:mt-[-100px] relative z-10">
    <SwiperSlide>
    ...
    <p className="text-[16px] md:text-[18px] lg:text-[20px] leading-[22px] md:leading-[24px] lg:leading-[25px]" style={{ color: '#69C0AC', fontWeight: 400 }}>{t('grupo.missao.text')}</p>
    </div>
    </SwiperSlide>
    <SwiperSlide>
    <div className="h-full flex flex-col p-4 lg:p-0">
    ...
    <p className="text-[16px] md:text-[18px] lg:text-[20px] leading-[22px] md:leading-[24px] lg:leading-[25px]" style={{ color: '#69C0AC', fontWeight: 400 }}>{t('grupo.visao.text')}</p>
    </div>
    </SwiperSlide>
    </Swiper>
    ...
    <Swiper modules={[Navigation, EffectCreative]} effect="creative" creativeEffect={{ prev: { translate: ['-100%', 0, 0], opacity: 0 }, next: { translate: ['100%', 0, 0], opacity: 0 } }} onSwiper={(swiper) => { swiperRef.current = swiper; }} onSlideChange={(swiper) => setCertActiveSlide(swiper.activeIndex)} spaceBetween={24} slidesPerView={1} className="drs360-swiper h-full w-full mt-0 lg:mt-[-100px] relative z-10">
    <SwiperSlide>
    <div className="h-full flex flex-col p-4 lg:p-0">
