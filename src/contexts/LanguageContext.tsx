...
export const translations: Translations = {
  pt: {
    ...
    // CTS SVG text keys
    'cts.svg1.line1': 'Fornecimento de',
    ...
    'cts.svg3.line1': 'Serviços globais',
  ...
  en: {
    ...
    'drs360.func1.line4': 'and drop sensors.',
    'drs360.func2.line1': 'Complete inventory visibility and',
    'drs360.func2.line2': 'control of entries and exits in',
    'drs360.func2.line3': 'real time — in the main warehouse',
    'drs360.func2.line4': 'or remote units, such as',
    'drs360.func2.line5': 'research centers.',
    'drs360.func3.line1': 'Smart and configurable alerts',
    'drs360.func3.line2': 'for proactive management —',
    'drs360.func3.line3': 'including temperature, operational',
    'drs360.func3.line4': 'deviations and restocking needs.',
    'drs360.func4.line1': 'Your entire project in a single',
    'drs360.func4.line2': 'environment: import, stock,',
    'drs360.func4.line3': 'supplies, logistics and billing',
    'drs360.func4.line4': 'together with total visibility',
    'drs360.func4.line5': 'and control.',
    'drs360.func5.line1': 'Complete history of each',
    'drs360.func5.line2': 'movement with permission levels',
    'drs360.func5.line3': 'and activity logging',
    'drs360.func5.line4': '(Compliance FDA, EMA & ANVISA)',
    'drs360.func6.line1': 'Management reports with dynamic',
    'drs360.func6.line2': 'views of volume, projects,',
    'drs360.func6.line3': 'periods, routes and more.',
    'drs360.func6.line4': 'OPEN API for process integration',
    'drs360.func6.line5': 'or data export.',
    'drs360.benefit1.line1': 'Reduction of losses and logistics',
    'drs360.benefit1.line2': 'deviations',
    'drs360.benefit2.line1': 'Increased predictability in',
    'drs360.benefit2.line2': 'clinical studies',
    'drs360.benefit3.line1': 'Support for real-time',
    'drs360.benefit3.line2': 'decision making',
    'drs360.security.title': 'Information security',
    'drs360.security.line1': 'The platform follows strict digital security protocols',
    'drs360.security.line2': 'and data privacy, with continuous backup,',
    'drs360.security.line3': 'secure cloud hosting and full compliance with',
    'drs360.security.line4': 'LGPD and international regulations (such as HIPAA and GDPR).',
    'drs360.security.bullet1': '• +115 active clients',
    'drs360.security.bullet2': '• +500 managed projects',
    'drs360.security.bullet3': '• Dashboard per clinical study, patient program or',
    ...
    'drs360.security.mobile.line2': 'security and data privacy protocols,',
    ...
    'drs360.security.mobile.bullet3': '• Dashboard per clinical study,',
    'drs360.security.mobile.bullet3b': 'patient program or logistics',
    'drs360.security.mobile.bullet4': '• Compliance FDA, EMA, ANVISA,',
    'drs360.security.mobile.bullet4b': 'LGPD/GDPR, ISO27001/27701',
    'drs360.access.title': 'Access the DRS 360 platform now.',
    'drs360.access.cta': 'Click here',
    'drs360.sol1.title': 'Real-time monitoring',
    'drs360.sol1.desc': 'Shipments with geolocation, temperature, humidity and drops for total visibility of your operations.',
    ...
    'drs360.sol2.title': 'Complete operation view',
    'drs360.sol2.desc': 'Real-time delivery and receiving control for efficient management.',
    ...
    'grupo.valor2.desc': 'We constantly seek the highest standards in our services and products.',
    ...
    'grupo.valor5.desc': 'We value teamwork to generate positive and lasting impact.',
    'grupo.nossotime.svg.line1': 'Our multidisciplinary team brings together logistics specialists,',
    'grupo.nossotime.svg.line2': 'pharmacists, nurses, data scientists and',
    'grupo.nossotime.svg.line3': 'technology developers. All aligned by a',
    'grupo.nossotime.svg.line4': 'common purpose: making access to healthcare more efficient,',
    'grupo.nossotime.svg.line5': 'safe and human.',
    'grupo.nossotime.svg.line6': 'Our culture is collaborative, focused on active listening and',
    'grupo.nossotime.svg.line7': 'people-centered solutions.',
    'grupo.nossotime.mobile.line1': 'People who care for people,',
    'grupo.nossotime.mobile.line2': 'with excellence and empathy.',
    'grupo.nossotime.mobile.line3': 'Our multidisciplinary team brings',
    'grupo.nossotime.mobile.line4': 'together logistics specialists,',
    'grupo.nossotime.mobile.line5': 'pharmacists, nurses, data scientists',
    'grupo.nossotime.mobile.line6': 'and technology developers.',
    'grupo.nossotime.mobile.line7': 'All aligned by a common purpose:',
    'grupo.nossotime.mobile.line8': 'making access to healthcare more',
    'grupo.nossotime.mobile.line9': 'efficient, safe and human.',
    'grupo.diff1.title1': 'DRS 360',
    'grupo.diff1.desc1': 'proprietary platform with',
    'grupo.diff1.desc2': 'real-time tracking,',
    'grupo.diff1.desc3': 'intelligent reports and predictive',
    ...
    'grupo.diff3.title1': 'Healthcare',
    'grupo.diff3.title2': 'specialization:',
    'grupo.diff3.desc1': '100% regulated operation, with',
    'grupo.diff3.desc2': 'validations and protocols for',
    'grupo.diff3.desc3': 'sensitive medications',
    'grupo.diff3.desc4': '',
    'grupo.area1.title1': 'Clinical Trial',
    'grupo.area1.title2': 'Services - CTS:',
    'grupo.area1.desc1': 'integrated and regulated solutions',
    'grupo.area1.desc2': 'for clinical studies, with total',
    ...
    'grupo.area2.desc3': 'treatment adherence and',
    'grupo.area2.desc4': 'specialized care.',
    'grupo.area3.title1': 'Thermo',
    'grupo.area3.title2': 'Integrated',
    'grupo.area3.title3': 'Services - TIS:',
    'grupo.area3.desc1': 'smart and sustainable cold',
    'grupo.area3.desc2': 'chain for sensitive products,',
    'grupo.area3.desc3': 'with high safety',
    ...
    'cts.svg1.desc1': 'Sourcing and import of',
    'cts.svg1.desc2': 'reference drugs for clinical',
    'cts.svg1.desc3': 'studies in any phase.',
    'cts.svg1.desc4': '',
    'cts.svg2.line1': 'Storage',
    'cts.svg2.line2': 'services',
    'cts.svg2.desc1': 'Specialized warehouse with',
    'cts.svg2.desc2': 'temperature control for',
    'cts.svg2.desc3': 'investigational products.',
    'cts.svg3.line1': 'Global official',
    'cts.svg3.line2': 'importer',
    'cts.svg3.line3': 'services',
    'cts.svg3.line4': '',
    'cts.svg3.desc1': 'Import and registration of',
    'cts.svg3.desc2': 'products for clinical research.',
    'cts.svg4.line1': 'Packaging,',
    'cts.svg4.line2': 'labeling and',
    'cts.svg4.line3': 'blinding',
    'cts.svg4.desc1': 'Repackaging, labeling and',
    'cts.svg4.desc2': 'blinding of investigational',
    'cts.svg4.desc3': 'drugs.',
    'cts.svg5.line1': 'Laboratory',
    'cts.svg5.line2': 'kits',
    'cts.svg5.desc1': 'Assembly and distribution',
    'cts.svg5.desc2': 'of kits for collection and',
    'cts.svg5.desc3': 'laboratory analysis.',
    'cts.svg6.line1': 'Specialized',
    'cts.svg6.line2': 'transport',
    'cts.svg6.desc1': 'Regulated logistics for',
    'cts.svg6.desc2': 'transport of sensitive',
    'cts.svg6.desc3': 'clinical materials.',
    ...
    'pcs.svg1.desc1': 'Comprehensive management of',
    'pcs.svg1.desc2': 'support programs for patients',
    'pcs.svg1.desc3': 'in continuous treatment.',
    'pcs.svg1.desc4': '',
    'pcs.svg2.line1': 'Consumer and',
    'pcs.svg2.line2': 'patient',
    'pcs.svg2.line3': 'services',
    'pcs.svg2.desc1': 'Specialized solutions for',
    'pcs.svg2.desc2': 'direct consumer and patient',
    'pcs.svg2.desc3': 'support and care.',
    'pcs.svg2.desc4': '',
    'pcs.svg3.line1': 'Innovative',
    'pcs.svg3.line2': 'therapies',
    'pcs.svg3.desc1': 'Logistic and clinical support',
    'pcs.svg3.desc2': 'for advanced and high-',
    'pcs.svg3.desc3': 'complexity therapies.',
    'pcs.svg3.desc4': '',
    'pcs.svg4.line1': 'Direct-to-',
    'pcs.svg4.line2': 'patient',
    'pcs.svg4.desc1': 'Direct delivery of medication',
    'pcs.svg4.desc2': 'to the patient\'s home with',
    'pcs.svg4.desc3': 'safety and traceability.',
    'pcs.svg4.desc4': '',
    'pcs.svg5.line1': 'Patient Kit',
    'pcs.svg5.line2': 'assembly',
    'pcs.svg5.desc1': 'Personalized kits for',
    'pcs.svg5.desc2': 'treatment and patient',
    'pcs.svg5.desc3': 'follow-up.',
    'pcs.svg5.desc4': '',
    'pcs.svg6.line1': 'Specialized',
    'pcs.svg6.line2': 'transport',
    'pcs.svg6.desc1': 'Dedicated logistics for',
    'pcs.svg6.desc2': 'transport of medications',
    'pcs.svg6.desc3': 'and patient materials.',
    'pcs.svg6.desc4': '',
    'pcs.sol1.title': 'Patient support program (PSP)',
    'pcs.sol1.desc': 'Comprehensive management of support programs for patients in continuous treatment, with personalized follow-up.',
    'pcs.sol2.title': 'Consumer and patient services',
    'pcs.sol2.desc': 'Specialized solutions for direct consumer and patient support and care.',
    'pcs.sol3.title': 'Innovative therapies',
    'pcs.sol3.desc': 'Logistic and clinical support for advanced and high-complexity therapies.',
    'pcs.sol4.title': 'Direct-to-patient',
    'pcs.sol4.desc': 'Direct delivery of medication to the patient\'s home with safety and full traceability.',
    'pcs.sol5.title': 'Patient Kit assembly',
    'pcs.sol5.desc': 'Personalized kits for treatment and individualized patient follow-up.',
    'pcs.sol6.title': 'Specialized transport',
    'pcs.sol6.desc': 'Dedicated logistics for safe transport of medications and patient materials.',

    // TIS SVG text keys
    'tis.svg1.line1': 'Cold chain and',
    'tis.svg1.line2': 'packaging',
    'tis.svg1.desc1': 'High-performance reusable',
    'tis.svg1.desc2': 'packaging for temperature-',
    'tis.svg1.desc3': 'controlled transport.',
    'tis.svg1.desc4': '',
    'tis.svg1.desc5': '',
    'tis.svg2.line1': 'Cold chain',
    'tis.svg2.line2': 'transport',
    'tis.svg2.desc1': 'Specialized logistics for',
    'tis.svg2.desc2': 'transport of temperature-',
    'tis.svg2.desc3': 'sensitive products.',
    'tis.svg2.desc4': '',
    'tis.svg2.desc5': '',
    'tis.svg3.line1': 'Import',
    'tis.svg3.line2': 'management',
    'tis.svg3.desc1': 'Complete management of',
    'tis.svg3.desc2': 'import and export processes',
    'tis.svg3.desc3': 'for sensitive products.',
    'tis.svg3.desc4': '',
    'tis.svg3.desc5': '',
    'tis.svg4.line1': 'Telemetry and',
    'tis.svg4.line2': 'Data Loggers',
    'tis.svg4.desc1': 'Continuous monitoring of',
    'tis.svg4.desc2': 'temperature, humidity and',
    'tis.svg4.desc3': 'real-time location.',
    'tis.svg4.desc4': '',
    'tis.svg4.desc5': '',
    'tis.sol1.title': 'Cold chain and sustainable packaging',
    'tis.sol1.desc': 'High-performance reusable packaging for temperature-controlled transport.',
    'tis.sol2.title': 'Cold chain transport',
    'tis.sol2.desc': 'Specialized logistics for transport of temperature-sensitive products with continuous monitoring.',
    'tis.sol3.title': 'Import and export management',
    'tis.sol3.desc': 'Complete management of import and export processes for sensitive products.',
    'tis.sol4.title': 'Telemetry and Data Loggers',
    'tis.sol4.desc': 'Continuous monitoring of temperature, humidity and real-time location.',
  ...
  es: {
    ...
    // DRS360 Page - Functionalities SVG
    'drs360.func1.line1': 'Rastreo en tiempo real de envíos',
    'drs360.func1.line2': 'con geolocalización,',
    'drs360.func1.line3': 'temperatura, humedad, sensores',
    'drs360.func1.line4': 'de luminosidad y caída.',
    'drs360.func2.line1': 'Visión completa de inventario y',
    'drs360.func2.line2': 'control de entradas y salidas en',
    'drs360.func2.line3': 'tiempo real — en el almacén',
    'drs360.func2.line4': 'principal o en unidades remotas,',
    'drs360.func2.line5': 'como centros de investigación.',
    'drs360.func3.line1': 'Alertas inteligentes y configurables',
    'drs360.func3.line2': 'para gestión proactiva — incluyendo',
    'drs360.func3.line3': 'temperatura, desvíos operacionales',
    'drs360.func3.line4': 'y necesidad de reabastecimiento.',
    'drs360.func4.line1': 'Todo su proyecto en un único',
    'drs360.func4.line2': 'ambiente: importación, inventario,',
    'drs360.func4.line3': 'suministros, logística y facturación',
    'drs360.func4.line4': 'reunidos con total visibilidad y',
    'drs360.func4.line5': 'control.',
    'drs360.func5.line1': 'Historial completo de cada',
    'drs360.func5.line2': 'movimiento con niveles de',
    'drs360.func5.line3': 'permisos y registro de actividades',
    'drs360.func5.line4': '(Compliance FDA, EMA & ANVISA)',
    'drs360.func6.line1': 'Reportes gerenciales con visiones',
    'drs360.func6.line2': 'dinámicas de volumen, proyectos,',
    'drs360.func6.line3': 'períodos, rutas y mucho más.',
    'drs360.func6.line4': 'OPEN API para integración de',
    'drs360.func6.line5': 'procesos o exportación de datos.',
    'drs360.benefit1.line1': 'Reducción de pérdidas y desvíos',
    'drs360.benefit1.line2': 'logísticos',
    'drs360.benefit2.line1': 'Aumento de la previsibilidad en',
    'drs360.benefit2.line2': 'estudios clínicos',
    'drs360.benefit3.line1': 'Apoyo a la toma de decisiones en',
    'drs360.benefit3.line2': 'tiempo real',
    'drs360.security.title': 'Seguridad de la información',
    'drs360.security.line1': 'La plataforma sigue rigurosos protocolos de seguridad digital',
    'drs360.security.line2': 'y privacidad de datos, con backup continuo,',
    'drs360.security.line3': 'alojamiento seguro en la nube y cumplimiento total con la',
    'drs360.security.line4': 'LGPD y regulaciones internacionales (como HIPAA y GDPR).',
    'drs360.security.bullet1': '• +115 clientes activos',
    'drs360.security.bullet2': '• +500 proyectos gestionados',
    'drs360.security.bullet3': '• Dashboard por estudio clínico, programa de paciente o',
    'drs360.security.bullet3b': 'proyecto logístico',
    'drs360.security.bullet4': '• Compliance FDA, EMA, ANVISA, LGPD/GDPR,',
    'drs360.security.bullet4b': 'ISO27001/27701',
    'drs360.security.mobile.title1': 'Seguridad de la',
    'drs360.security.mobile.title2': 'información',
    'drs360.security.mobile.line1': 'La plataforma sigue rigurosos',
    'drs360.security.mobile.line2': 'protocolos de seguridad digital y',
    'drs360.security.mobile.line3': 'privacidad de datos, con backup',
    'drs360.security.mobile.line4': 'continuo, alojamiento seguro en la',
    'drs360.security.mobile.line5': 'nube y cumplimiento total con la',
    ...
    'drs360.sol1.title': 'Monitoreo en tiempo real',
    'drs360.sol1.desc': 'Envíos con geolocalización, temperatura, humedad y caídas para total visibilidad de sus operaciones.',
    'drs360.sol1.dif1': 'Rastreo GPS en tiempo real', 'drs360.sol1.dif2': 'Monitoreo de temperatura y humedad',
    'drs360.sol1.dif3': 'Detección de impacto y caídas', 'drs360.sol1.dif4': 'Alertas automáticas personalizables',
    'drs360.sol1.dest1': 'Dashboard unificado para todas las operaciones',
    'drs360.sol1.dest2': 'Historial completo de movimientos', 'drs360.sol1.dest3': 'Integración con sistemas existentes',
    ...
    'drs360.sol2.dif1': 'Panel de control centralizado', 'drs360.sol2.dif2': 'Visualización de todas las entregas',
    'drs360.sol2.dif3': 'Estado en tiempo real de cada envío', 'drs360.sol2.dif4': 'Reportes de rendimiento',
    'drs360.sol2.dest1': 'Interfaz intuitiva y responsiva', 'drs360.sol2.dest2': 'Acceso multi-dispositivo',
    ...
    'drs360.sol3.dif1': 'Alertas por temperatura fuera de rango', 'drs360.sol3.dif2': 'Notificaciones de retraso de entrega',
    'drs360.sol3.dif3': 'Avisos de desvío de ruta', 'drs360.sol3.dif4': 'Escalación automática de incidentes',
    'drs360.sol3.dest1': 'Configuración flexible por usuario', 'drs360.sol3.dest2': 'Múltiples canales de notificación',
    'drs360.sol3.dest3': 'Reportes de ocurrencias',
    'drs360.sol4.title': 'Historial completo', 'drs360.sol4.desc': 'Rastreo completo de cada movimiento para auditoría y compliance.',
    'drs360.sol4.dif1': 'Registro de todos los movimientos', 'drs360.sol4.dif2': 'Logs de acceso y modificaciones',
    'drs360.sol4.dif3': 'Documentación automática', 'drs360.sol4.dif4': 'Exportación de datos',
    'drs360.sol4.dest1': 'Retención de datos según regulación', 'drs360.sol4.dest2': 'Búsqueda avanzada por período',
    'drs360.sol4.dest3': 'Reportes personalizados',
    'drs360.sol5.title': 'Reportes personalizados', 'drs360.sol5.desc': 'Reportes listos validados para compliance FDA, ANVISA y otras agencias.',
    'drs360.sol5.dif1': 'Templates preconfigurados', 'drs360.sol5.dif2': 'Personalización de reportes',
    'drs360.sol5.dif3': 'Exportación en múltiples formatos', 'drs360.sol5.dif4': 'Programación automática',
    'drs360.sol5.dest1': 'Conformidad con FDA y ANVISA', 'drs360.sol5.dest2': 'Firma digital', 'drs360.sol5.dest3': 'Versionado de documentos',
    'drs360.sol6.title': 'Seguridad de la información', 'drs360.sol6.desc': 'Protocolos rigurosos de seguridad digital para protección de datos sensibles.',
    'drs360.sol6.dif1': 'Cifrado de extremo a extremo', 'drs360.sol6.dif2': 'Autenticación multifactor',
    'drs360.sol6.dif3': 'Control de acceso granular', 'drs360.sol6.dif4': 'Backup automático',
    'drs360.sol6.dest1': 'Conformidad con LGPD', 'drs360.sol6.dest2': 'Certificaciones de seguridad', 'drs360.sol6.dest3': 'Monitoreo 24/7',
    'grupo.valor1.title': 'Ética y transparencia', 'grupo.valor1.desc': 'Actuamos con integridad y responsabilidad en todas nuestras relaciones.',
    'grupo.valor2.title': 'Excelencia y Calidad', 'grupo.valor2.desc': 'Buscamos constantemente los más altos estándares en nuestros servicios y productos.',
    'grupo.valor3.title': 'Compromiso con la Vida', 'grupo.valor3.desc': 'Ponemos a los pacientes en el centro de todo lo que hacemos.',
    'grupo.valor4.title': 'Innovación y Tecnología', 'grupo.valor4.desc': 'Utilizamos soluciones de vanguardia para impulsar la evolución de la salud.',
    'grupo.valor5.title': 'Colaboración y Asociación', 'grupo.valor5.desc': 'Valoramos el trabajo conjunto para generar impactos positivos y duraderos.',
    ...
    'grupo.nossotime.svg.line6': 'Nuestra cultura es colaborativa, con foco en la escucha activa y',
    'grupo.nossotime.svg.line7': 'soluciones centradas en personas.',
    'grupo.nossotime.mobile.line1': 'Personas que cuidan de personas,',
    'grupo.nossotime.mobile.line2': 'con excelencia y empatía.',
    'grupo.nossotime.mobile.line3': 'Nuestro equipo multidisciplinario',
    'grupo.nossotime.mobile.line4': 'reúne especialistas en logística,',
    'grupo.nossotime.mobile.line5': 'farmacéuticos, enfermeros, científicos',
    'grupo.nossotime.mobile.line6': 'de datos y desarrolladores de',
    'grupo.nossotime.mobile.line7': 'tecnología. Todos alineados por un',
    'grupo.nossotime.mobile.line8': 'propósito común: hacer el acceso a la',
    'grupo.nossotime.mobile.line9': 'salud más eficiente, seguro y humano.',
    'grupo.diff1.title1': 'DRS 360', 'grupo.diff1.desc1': 'plataforma propietaria con', 'grupo.diff1.desc2': 'rastreo en tiempo real,',
    'grupo.diff1.desc3': 'reportes inteligentes y gestión', 'grupo.diff1.desc4': 'predictiva',
    'grupo.diff2.title1': 'Ecosistema', 'grupo.diff2.title2': 'completo:',
    'grupo.diff2.desc1': 'logística, tecnología, soporte al', 'grupo.diff2.desc2': 'paciente y servicios regulatorios',
    'grupo.diff2.desc3': 'en una única estructura', 'grupo.diff2.desc4': 'operacional.',
    'grupo.diff3.title1': 'Especialización', 'grupo.diff3.title2': 'en salud:',
    'grupo.diff3.desc1': 'operación 100% regulada, con', 'grupo.diff3.desc2': 'validaciones y protocolos para',
    'grupo.diff3.desc3': 'medicamentos sensibles', 'grupo.diff3.desc4': '',
    'grupo.area1.title1': 'Clinical Trial', 'grupo.area1.title2': 'Services - CTS:',
    'grupo.area1.desc1': 'soluciones integradas y reguladas', 'grupo.area1.desc2': 'para estudios clínicos, con total',
    'grupo.area1.desc3': 'trazabilidad y compliance', 'grupo.area1.desc4': 'internacional.',
    'grupo.area2.title1': 'Patient Centric', 'grupo.area2.title2': 'Services - PCS:',
    'grupo.area2.desc1': 'terapias y soporte al paciente,', 'grupo.area2.desc2': 'con entregas domiciliarias,',
    'grupo.area2.desc3': 'adherencia al tratamiento y', 'grupo.area2.desc4': 'atención especializada.',
    'grupo.area3.title1': 'Thermo', 'grupo.area3.title2': 'Integrated', 'grupo.area3.title3': 'Services - TIS:',
    'grupo.area3.desc1': 'cadena de frío inteligente y', 'grupo.area3.desc2': 'sostenible para productos',
    'grupo.area3.desc3': 'sensibles, con alto estándar', 'grupo.area3.desc4': 'de seguridad.',

    // CTS SVG text keys
    'cts.svg1.line1': 'Suministro de',
    'cts.svg1.line2': 'medicamentos',
    'cts.svg1.line3': 'comparadores',
    'cts.svg1.desc1': 'Sourcing e importación de',
    'cts.svg1.desc2': 'medicamentos de referencia',
    'cts.svg1.desc3': 'para estudios clínicos en',
    'cts.svg1.desc4': 'cualquier fase.',
    'cts.svg2.line1': 'Servicio de',
    'cts.svg2.line2': 'almacenaje',
    'cts.svg2.desc1': 'Depósito especializado con',
    'cts.svg2.desc2': 'temperatura controlada para',
    'cts.svg2.desc3': 'productos investigacionales.',
    'cts.svg3.line1': 'Servicios globales',
    'cts.svg3.line2': 'de importador',
    'cts.svg3.line3': 'oficial',
    'cts.svg3.line4': '',
    'cts.svg3.desc1': 'Importación y registro de',
    'cts.svg3.desc2': 'productos para investigación clínica.',
    'cts.svg4.line1': 'Embalaje,',
    'cts.svg4.line2': 'etiquetado y',
    'cts.svg4.line3': 'cegamiento',
    'cts.svg4.desc1': 'Reembalaje, etiquetado y',
    'cts.svg4.desc2': 'cegamiento de medicamentos',
    'cts.svg4.desc3': 'investigacionales.',
    'cts.svg5.line1': 'Kits',
    'cts.svg5.line2': 'laboratoriales',
    'cts.svg5.desc1': 'Montaje y distribución',
    'cts.svg5.desc2': 'de kits para recolección y',
    'cts.svg5.desc3': 'análisis laboratorial.',
    'cts.svg6.line1': 'Transporte',
    'cts.svg6.line2': 'especializado',
    'cts.svg6.desc1': 'Logística regulada para',
    'cts.svg6.desc2': 'transporte de materiales',
    'cts.svg6.desc3': 'clínicos sensibles.',
    ...
    'pcs.svg1.line3': 'paciente (PSP)',
    'pcs.svg1.desc1': 'Gestión integral de programas',
    'pcs.svg1.desc2': 'de soporte para pacientes en',
    'pcs.svg1.desc3': 'tratamiento continuo.',
    'pcs.svg1.desc4': '',
    'pcs.svg2.line1': 'Servicios para',
    'pcs.svg2.line2': 'consumidores y',
    'pcs.svg2.line3': 'pacientes',
    'pcs.svg2.desc1': 'Soluciones especializadas para',
    'pcs.svg2.desc2': 'atención y soporte directo',
    'pcs.svg2.desc3': 'al consumidor y paciente.',
    'pcs.svg2.desc4': '',
    'pcs.svg3.line1': 'Terapias',
    'pcs.svg3.line2': 'innovadoras',
    'pcs.svg3.desc1': 'Soporte logístico y clínico para',
    'pcs.svg3.desc2': 'terapias avanzadas y de alta',
    'pcs.svg3.desc3': 'complejidad.',
    'pcs.svg3.desc4': '',
    'pcs.svg4.line1': 'Direct-to-',
    'pcs.svg4.line2': 'patient',
    'pcs.svg4.desc1': 'Entrega directa de medicamentos',
    'pcs.svg4.desc2': 'en el domicilio del paciente con',
    'pcs.svg4.desc3': 'seguridad y trazabilidad.',
    'pcs.svg4.desc4': '',
    'pcs.svg5.line1': 'Montaje de',
    'pcs.svg5.line2': 'Patient Kits',
    'pcs.svg5.desc1': 'Kits personalizados para',
    'pcs.svg5.desc2': 'tratamiento y seguimiento',
    'pcs.svg5.desc3': 'del paciente.',
    'pcs.svg5.desc4': '',
    'pcs.svg6.line1': 'Transporte',
    'pcs.svg6.line2': 'especializado',
    'pcs.svg6.desc1': 'Logística dedicada para',
    'pcs.svg6.desc2': 'transporte de medicamentos',
    'pcs.svg6.desc3': 'y materiales de pacientes.',
    'pcs.svg6.desc4': '',
    'pcs.sol1.title': 'Programa de soporte al paciente (PSP)',
    'pcs.sol1.desc': 'Gestión integral de programas de soporte para pacientes en tratamiento continuo.',
    'pcs.sol2.title': 'Servicios para consumidores y pacientes',
    'pcs.sol2.desc': 'Soluciones especializadas para atención y soporte directo al consumidor y paciente.',
    'pcs.sol3.title': 'Terapias innovadoras',
    'pcs.sol3.desc': 'Soporte logístico y clínico para terapias avanzadas y de alta complejidad.',
    'pcs.sol4.title': 'Direct-to-patient',
    'pcs.sol4.desc': 'Entrega directa de medicamentos en el domicilio del paciente con seguridad y trazabilidad total.',
    'pcs.sol5.title': 'Montaje de Patient Kits',
    'pcs.sol5.desc': 'Kits personalizados para tratamiento y seguimiento individualizado del paciente.',
    'pcs.sol6.title': 'Transporte especializado',
    'pcs.sol6.desc': 'Logística dedicada para transporte seguro de medicamentos y materiales de pacientes.',

    // TIS SVG + modal keys
    'tis.svg1.line1': 'Cadena de frío y',
    'tis.svg1.line2': 'embalajes',
    'tis.svg1.desc1': 'Embalajes reutilizables de',
    'tis.svg1.desc2': 'alto rendimiento para',
    'tis.svg1.desc3': 'transporte en temperatura',
    'tis.svg1.desc4': 'controlada.',
    'tis.svg1.desc5': '',
    'tis.svg2.line1': 'Transporte de',
    'tis.svg2.line2': 'cadena de frío',
    'tis.svg2.desc1': 'Logística especializada en',
    'tis.svg2.desc2': 'transporte de productos',
    'tis.svg2.desc3': 'termosensibles.',
    'tis.svg2.desc4': '',
    'tis.svg2.desc5': '',
    'tis.svg3.line1': 'Gestión de',
    'tis.svg3.line2': 'importación',
    'tis.svg3.desc1': 'Gestión completa de procesos',
    'tis.svg3.desc2': 'de importación y exportación',
    'tis.svg3.desc3': 'de productos sensibles.',
    'tis.svg3.desc4': '',
    'tis.svg3.desc5': '',
    'tis.svg4.line1': 'Telemetría y',
    'tis.svg4.line2': 'Data Loggers',
    'tis.svg4.desc1': 'Monitoreo continuo de',
    'tis.svg4.desc2': 'temperatura, humedad y',
    'tis.svg4.desc3': 'localización en tiempo real.',
    'tis.svg4.desc4': '',
    'tis.svg4.desc5': '',
    'tis.sol1.title': 'Cadena de frío y embalajes sostenibles',
    'tis.sol1.desc': 'Embalajes reutilizables de alto rendimiento para transporte en temperatura controlada.',
    'tis.sol2.title': 'Transporte de cadena de frío',
    'tis.sol2.desc': 'Logística especializada en transporte de productos termosensibles con monitoreo continuo.',
    'tis.sol3.title': 'Gestión de importación y exportación',
    'tis.sol3.desc': 'Gestión completa de procesos de importación y exportación de productos sensibles.',
    'tis.sol4.title': 'Telemetría y Data Loggers',
    'tis.sol4.desc': 'Monitoreo continuo de temperatura, humedad y localización en tiempo real.',
